...
description: >
  ...
  (design_phosphor_icon), or creative/design requests (request_design).
---
...
if: session.request_swag.swag_purpose == 'events'
...
if: session.request_swag.swag_purpose == 'personal'
...
if: session.request_swag.swag_purpose == 'customer_community'
