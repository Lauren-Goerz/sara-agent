...
async def get_crowdstrike_info(
    query: str = "",
    context: ToolContext = None,
) -> ToolResult:
    """Return live CrowdStrike FAQ content for employee questions.

    Args:
        query: Topic (e.g. what is it, web browsing, who has access).
    """
    payload = await notion_sources.load("crowdstrike", query=query)
