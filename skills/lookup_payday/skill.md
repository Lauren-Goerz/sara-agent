...
description: >
  ...
  day of month. Do NOT activate for leave balances (leave_check), public
  holiday calendars (lookup_holidays), or benefits (lookup_benefits).
---
...
2. If it asks for location or Deel schedule, ask one short clarifying
   question, then call again with `location_override` or `pay_setup`
